            ...
            <Tabs defaultValue="general" className="w-full">
                ...
                <TabsContent value="pricing">
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                <Label htmlFor="xafPrice" className="mb-2">
                                    Base Price
                                </Label>
                                <Input
                                    id="xafPrice"
                                    type="number"
                                    value={course?.aboutCourse?.pricing?.xafPrice || 0}
                                    onChange={(e) => handleChange("aboutCourse.pricing.xafPrice", Number(e.target.value))}
